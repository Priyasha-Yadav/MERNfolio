...
export const portfolioAPI = {
  ...
  addEducation: (userId, data) => api.post(`/portfolio/${userId}/education`, data),
  updateEducation: (userId, eduIndex, data) => api.put(`/portfolio/${userId}/education/${eduIndex}`, data),
  deleteEducation: (userId, eduIndex) => api.delete(`/portfolio/${userId}/education/${eduIndex}`),
  addCertification: (userId, data) => api.post(`/portfolio/${userId}/certifications`, data),
  updateCertification: (userId, certIndex, data) => api.put(`/portfolio/${userId}/certifications/${certIndex}`, data),
  deleteCertification: (userId, certIndex) => api.delete(`/portfolio/${userId}/certifications/${certIndex}`),
